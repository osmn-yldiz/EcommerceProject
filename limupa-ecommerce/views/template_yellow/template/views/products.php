        ...
        <div class="row">
            <div class="col-lg-9 order-1 order-lg-2">
                ...
                <div class="single-banner shop-page-banner">
                    <a href="#">
                        <img src="<?= TEMPLATE ?>images/bg-banner/2.jpg" alt="Li's Static Banner">
                    </a>
                </div>
                ...
                <div class="shop-products-wrapper">
                    <div class="tab-content">
                                        ...
                                        <div class="single-product-wrap">
                                            <div class="product-image">
                                                <a href="single-product.html">
                                                    <img src="uploads/products/<?php echo $Products['Images']; ?>"
                                                        alt="Li's Product Image">
                                                </a>
                                                <?php if(isset($products->Desc[$Products['ID']][1])){ ?><span
                                                    class="sticker"><?php echo $products->Desc[$Products['ID']][1]; ?></span><?php } ?>
                                                <?php if(isset($products->Desc[$Products['ID']][2])){ ?><span
                                                    class="free-cargo"><?php echo $products->Desc[$Products['ID']][2]; ?></span><?php } ?>
                                                <?php if(isset($products->Desc[$Products['ID']][3])){ ?><span
                                                    class="hizli"><?php echo $products->Desc[$Products['ID']][3]; ?></span><?php } ?>
                                            </div>
                                            <div class="product_desc">
                                                <div class="product_desc_info">
                                                    ...
                                                    <h4><a class="product_name"
                                                            href="single-product.html"><?php echo $Products['Name']; ?></a>
                                                    </h4>
                                                    <div class="price-box">
                                                        <span class="new-price"><?php echo $Products['Price']; ?>
                                                            ₺</span>
                                                    </div>
                                                    <input type="number" name="Quantity_<?php print $Products['ID']; ?>" min="1" value="<?php echo $Basket[$Products['ID']]['Quantity'] ?>">
                                                </div>

                                                <div class="add-actions">
                                                    <ul class="add-actions-link">
                                                        <li class="add-cart active"><a href="javascript:void(0)" onclick="basketAdd(<?php echo $Products['ID']; ?>)">Sepete ekle</a></li>
                        ...
                        <!--<div class="paginatoin-area">
                                    ...
                                    print "<div class='col-lg-6 col-md-6 pt-xs-15'>";
                                    echo "Page ".$currentpage." of ".$totalpages."<br>";
                                    print "</div>";
                                   print  '<div class="col-lg-6 col-md-6">';
                                   print '<ul class="pagination-box pt-xs-20 pb-xs-15">';
                                  
                                    if ($currentpage > 1) 
                                        {
                                        echo "<li class='Previous'> <a href='index.php?".$build."&currentpage=1'><<</a></li> ";
                                        $prevpage = $currentpage - 1;
                                        echo " <li class='page-item'><a href='index.php?".$build."&currentpage=$prevpage'><</a></li> ";
                                        } 
                                        ...
                                        for ($x = ($currentpage - $range); $x < (($currentpage + $range) + 1); $x++)
                                        {
                                            if (($x > 0) && ($x <= $totalpages))
                                            {
                                                ...
                                                {
                                                    echo " <li class='page-item'><a href='index.php?".$build."&currentpage=$x'>$x</a></li> ";
                                                }
                                            }
                                        } 
                                        if ($currentpage != $totalpages)
                                        {
                                            ...
                                            echo " <li class='Next'><a href='index.php?".$build."&currentpage=$nextpage'>></a></li> ";
                                            echo "<li class='Next'> <a href='index.php?".$build."&currentpage=$totalpages'>>></a></li> ";
                                        }
                                        print "</ul>";
                                        print '</div>';
                                        ?>
...
<input type="hidden" name="csrf_token" value="<?php echo $_SESSION['csrf_token'] = uniqid(); ?>">
    <script>
    $(document).ready(function () {
        
    });

    function basketAdd(ProductsID) {
       
        $.post({
            url: "ajax/basketAdd.php",
            data: 'ProductsID='+ProductsID+'&Quantity='+$("input[name='Quantity_"+ProductsID+"']").val()+'&csrf_token='+$("input[name='csrf_token']").val(),
            cache: false,
            dataType: 'json',
            success: function (ajaxAnswer) {
              alert(ajaxAnswer['message']);
            },
            error: function (hata) {
