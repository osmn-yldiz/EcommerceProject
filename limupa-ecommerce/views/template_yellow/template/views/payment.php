                        ...
                        <tr>
                            <td>
                                <div class="form-check form-check-inline">
                                    <input type="radio" class="form-check-input" name="shippingAdress"
                                           value="<?php echo $shipping['ID']; ?>" <?php echo ($shipping['Active'] == 1) ? 'checked' : '' ?> >
                                </div>
                            </td>
                            <td><?php echo $shipping['FullName']; ?></td>
                            <td><?php echo $shipping['City']; ?></td>
                            <td><?php echo $shipping['Adress']; ?></td>
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <?php foreach ($billingList as $billing) { ?>
                        <tr>
                            <td>
                                <div class="form-check form-check-inline">
                                    <input type="radio" class="form-check-input" name="billingAdress"
                                           value="<?php echo $billing['ID']; ?>" <?php echo ($billing['Active'] == 1) ? 'checked' : '' ?> >
                                </div>
                            </td>
                            <td><?php echo $billing['FullName']; ?></td>
                            <td><?php echo $billing['City']; ?></td>
                            <td><?php echo $billing['Adress']; ?></td>
